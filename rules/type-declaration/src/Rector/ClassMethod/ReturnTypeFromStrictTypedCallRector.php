        ...
        foreach ($returns as $return) {
            ...
            if ($returnedExpr instanceof MethodCall || $returnedExpr instanceof StaticCall || $returnedExpr instanceof FuncCall) {
                ...
                if ($returnedExpr instanceof FuncCall) {
                    $callerNode = $this->nodeRepository->findFunctionByFuncCall($returnedExpr);
                    if ($callerNode === null) {
                        // @todo handle with reflection
                        throw new ShouldNotHappenException();
                    }

                    $returnNode = $callerNode->returnType;
                    if ($returnNode === null) {
                        return [];
                    }
